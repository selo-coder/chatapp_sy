    ...
    <div className="w-full bg-dark-green h-24 flex justify-between items-center px-6 md:px-8">
      ...
      <div className="relative" ref={observerRef}>
        <button
          ...
          type="button"
          className="w-10 h-10 z-10 rounded-full relative bg-swamp-green hover:bg-swamp-green/75 active:bg-swamp-green/50 flex items-center justify-center cursor-pointer"
        >
          {data?.user && (
        ...
        {showMenu && (
          <div className="w-24 p-2 rounded-lg bg-swamp-green z-0 absolute left-[50%] translate-x-[-50%] top-0 flex flex-col">
            <div className="h-8" />
